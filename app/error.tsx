...
export default function Error({ error, reset }: Props) {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-4xl items-center justify-center px-4 py-12 sm:px-8">
        ...
        <div className="relative rounded-2xl border border-cyan-300/18 bg-slate-900/55 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.03),0_0_24px_rgba(8,145,178,0.08)]">
          <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <h1 className="mt-2 text-2xl font-semibold text-slate-50">A aparut o eroare</h1>
              <p className="mt-2 text-sm leading-6 text-slate-300">
                A aparut o eroare neasteptata la afisarea acestei pagini.
              </p>
            </div>
